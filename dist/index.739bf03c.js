...
var _magnetic = require("./magnetic");
var _magneticDefault = parcelHelpers.interopDefault(_magnetic);
// Splide JS
...
//=== init Cursor
const cursor = new (0, _cursorDefault.default)({
    container: "body",
    speed: 0.7,
    ease: "expo.out",
    visibleTimeout: 300
});
const magnetic = new (0, _magneticDefault.default)({
    y: 0.2,
    x: 0.2,
    s: 0.2,
    rs: 0.7
...
(0, _jqueryDefault.default)("[data-magnetic]").each(function() {
    new (0, _magneticDefault.default)(this);
});
/* ========= PRELOADER to Header ====== */ tl.from(".loader-wrap-heading .loader-wrap-heading-progress", {
    delay: 0.5,
    y: 200
...
(0, _scrollTrigger.ScrollTrigger).scrollerProxy(scroll.el, {
    scrollTop (value) {
...
},{"locomotive-scroll":"iDXE3","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","jquery":"hgMhh","./cursor":"3v1v0","./magnetic":"e8y6V","@splidejs/splide":"5CJev","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iDXE3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Cursor {
    constructor(options){
        this.options = (0, _jqueryDefault.default).extend(true, {
            container: "body",
            speed: 0.7,
            ease: "expo.out",
            visibleTimeout: 300
        }, options);
        this.body = (0, _jqueryDefault.default)(this.options.container);
        this.el = (0, _jqueryDefault.default)('<div class="cb-cursor"></div>');
        this.text = (0, _jqueryDefault.default)('<div class="cb-cursor-text"></div>');
        this.init();
    }
    init() {
    ...
    setStick(el) {
        const target = (0, _jqueryDefault.default)(el);
...
},{"jquery":"hgMhh","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e8y6V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
...
},{"jquery":"hgMhh","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5CJev":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequirefd56")
